    ...
    <section className="bg-gradient-to-r from-blue-600 to-blue-800 py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center text-white">
          ...
          <div className="mb-12">
            <button className="bg-white text-blue-600 px-12 py-5 rounded-xl hover:bg-gray-50 transition-colors font-bold text-xl shadow-2xl hover:shadow-3xl flex items-center gap-3 mx-auto">
